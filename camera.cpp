...
#define	VIEW_NEAR_Z		(3.0f)											// ビュー平面のNearZ値
...
void SetCameraAT(XMFLOAT3 pos)
{
	...
	//g_Camera.pos.x = g_Camera.at.x - sinf(g_Camera.rot.y) * 0.01f;//g_Camera.len;
	//g_Camera.pos.z = g_Camera.at.z - cosf(g_Camera.rot.y) * 0.01f;//g_Camera.len;

}

void SetFPSCameraAt(XMFLOAT3 lookAtPos, XMFLOAT3 pos) 
{
	g_Camera.at = lookAtPos;
	...
	*/
	...
	float w = sqrt(g_Camera.at.x * g_Camera.at.x + g_Camera.at.y * g_Camera.at.y + g_Camera.at.z * g_Camera.at.z);

	//g_Camera.rot.y = g_Camera.at.y / w;

	//g_Camera.rot.y = g_Camera.at.y;
